...
def security_settings(request):
    ...
    return render(request, 'django_mfa/security.html', {"prev_url": settings.LOGIN_REDIRECT_URL, "backup_codes": backup_codes, "twofactor_enabled": twofactor_enabled})
...
def verify_second_factor(request):
    if request.method == "GET":
        ...
        if twofactor_enabled:
            return render(request, 'django_mfa/verify_second_factor.html', {"twofactor_enabled": twofactor_enabled})
